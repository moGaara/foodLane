...
import com.app.foodlane.cart.service.CartItemCustomizationService;
import com.app.foodlane.cart.service.CartItemService;
...
public class CartService {
    ...
    public CartResponseDto addItem(long customerId, AddToCartRequesttDto requestDto) {
        ...
        return new CartResponseDto(1L, 1L, "", new ArrayList<>(), new BigDecimal(1)); // dummy data to run the app
    }
