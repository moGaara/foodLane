...
public enum ErrorMapping {
    ORDER_NOT_FOUND(
            ErrorConstants.ORDER_NOT_FOUND_CODE,
            ErrorConstants.ORDER_NOT_FOUND_DESC),

    ORDER_STATUS_NOT_FOUND(
            ErrorConstants.ORDER_STATUS_NOT_FOUND_CODE,
            ErrorConstants.ORDER_STATUS_NOT_FOUND_DESC),

    INVALID_ORDER_STATUS_TRANSITION(
            ErrorConstants.INVALID_ORDER_STATUS_TRANSITION_CODE,
            ErrorConstants.INVALID_ORDER_STATUS_TRANSITION_DESC),
    USER_NOT_FOUND(
            ErrorConstants.USER_NOT_FOUND_CODE,
            ErrorConstants.USER_NOT_FOUND_DESC),
    ORDER_STATUS_UPDATE_FORBIDDEN(
            ErrorConstants.ORDER_STATUS_UPDATE_FORBIDDEN_CODE,
            ErrorConstants.ORDER_STATUS_UPDATE_FORBIDDEN_DESC),
    ...
    CUSTOMIZATION_NOT_ALLOWED(ErrorConstants.CUSTOMIZATION_NOT_ALLOWED_CODE,
            ErrorConstants.CUSTOMIZATION_NOT_ALLOWED_DESC),
    INVALID_CUSTOMIZATION_SELECTION(ErrorConstants.INVALID_CUSTOMIZATION_SELECTION_CODE,
            ErrorConstants.INVALID_CUSTOMIZATION_SELECTION_DESC),
    ACTIVE_CART_NOT_FOUND(ErrorConstants.ACTIVE_CART_NOT_FOUND_CODE, ErrorConstants.ACTIVE_CART_NOT_FOUND_DESC),
    EMPTY_CART(ErrorConstants.EMPTY_CART_CODE, ErrorConstants.EMPTY_CART_DESC),
    RESTAURANT_CLOSED(ErrorConstants.RESTAURANT_CLOSED_CODE, ErrorConstants.RESTAURANT_CLOSED_DESC),
    DELIVERY_ADDRESS_NOT_FOUND(ErrorConstants.DELIVERY_ADDRESS_NOT_FOUND_CODE,
            ErrorConstants.DELIVERY_ADDRESS_NOT_FOUND_DESC),
