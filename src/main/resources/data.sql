...
(3, 'Tariq Al-Balushi', 'tariq.driver@example.com', '+96895551122', '$2a$12$e8Uv...hash3', 'CUSTOMER', TRUE),
(4, 'Khaled Courier', 'khaled.courier@example.com', '+96894443311', '$2a$12$e8Uv...hash4', 'COURIER', TRUE),
(5, 'Ahmed Courier', 'ahmed.courier@example.com', '+96894445432', '$2a$12$e8Uv...hash4', 'COURIER', TRUE),
(6, 'Admin User', 'admin@foodland.com', '+96890000000', '$2a$12$e8Uv...hash5', 'ADMIN', TRUE);
...
INSERT INTO courier (courier_id, vehicle_type, license_plate, is_available, current_latitude, current_longitude) VALUES
                                                                                                                     (4, 'MOTORCYCLE', 'OM-10293', TRUE, 23.5880, 58.3829),
                                                                                                                     (5, 'CAR', 'OM-44921', FALSE, 23.6001, 58.4100);
...
INSERT INTO "order" (order_id, customer_id, restaurant_id, current_status_id, courier_id, subtotal, discount_amount, delivery_fee, service_fee, total_amount, estimated_delivery, placed_at) VALUES
                                                                                                                                                                                                 (1001, 1, 1, 6, 4, 2.40, 0.48, 0.00, 0.07, 1.99, '2026-09-10 12:45:00', '2026-09-10 12:15:00'),
                                                                                                                                                                                                 (1002, 2, 1, 5, 5, 5.50, 0.00, 0.59, 0.10, 6.19, '2026-09-10 13:30:00', '2026-09-10 12:50:00');
